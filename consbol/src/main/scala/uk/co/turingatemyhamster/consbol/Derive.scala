...
trait Derive[A, M] {
  def apply(a: A, goals: Set[Object], m0: M): Stream[(Proof[A], M)]
}
...
object Derive extends DeriveLowPriorityImpicits {
  ...
  implicit class DeriveOps[M](val _m: M) {
    def derive[A](a: A, goals: Set[Object])(implicit d: Derive[A, M]): Stream[(Proof[A], M)] =
      d(a, goals, _m)

    def derive[A](a: A)(implicit d: Derive[A, M]): Stream[(Proof[A], M)] =
      d(a, Set(), _m)
  }
  
  private def lastModel[A, M](k: Stream[(Proof[A], M)], m0: M) =
    k.to[Stream].lastOption map (_._2) getOrElse m0
  ...
  : Derive[LT[I], Model[V, I]] = new Derive[LT[I], Model[V, I]] {
    ...
    override def apply(a: LT[I], goals: Set[Object], m0: Model[V, I]): Stream[(Proof[LT[I]], Model[V, I])] = {
  ...
  : Derive[LT[I], Model[V, I]] = new Derive[LT[I], Model[V, I]] {
    override def apply(a: LT[I], goals: Set[Object], m0: Model[V, I]): Stream[(Proof[LT[I]], Model[V, I])] = {
      ...
      for {
        x <- m0.allInterpretations.to[Stream]
  ...
  : Derive[LT_EQ[I], Model[V, I]] = new Derive[LT_EQ[I], Model[V, I]] {
    override def apply(a: LT_EQ[I], goals: Set[Object], m0: Model[V, I]): Stream[(Proof[LT_EQ[I]], Model[V, I])] =
      if(goals contains a) {
        Stream()
      } else {
        val g = goals + a
  ...
  : Derive[EQ[I], Model[V, I]] = new Derive[EQ[I], Model[V, I]] {
    override def apply(a: EQ[I], goals: Set[Object], m0: Model[V, I]): Stream[(Proof[EQ[I]], Model[V, I])] =
      if(goals contains a) {
        Stream()
      } else for {
  ...
  : Derive[NOT_EQ[I], Model[V, I]] = new Derive[NOT_EQ[I], Model[V, I]] {
    override def apply(a: NOT_EQ[I], goals: Set[Object], m0: Model[V, I]): Stream[(Proof[NOT_EQ[I]], Model[V, I])] =
      if(goals contains a) {
        Stream()
      } else {
        val g = goals + a
...
trait DeriveLowPriorityImpicits {
  ...
  : Derive[A[V], Model[V, I]] = new Derive[A[V], Model[V, I]] {
    ...
    override def apply(a: A[V], goals: Set[Object], m0: Model[V, I]): Stream[(Proof[A[V]], Model[V, I])] = {
